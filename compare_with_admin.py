...
def run_optimized_assignments(admin_data):
    ...
    admin_map = visualize_assignments(
        ...
        save_path=os.path.join(output_dir, f"admin_assignment_map_{timestamp}.html"),
        show=True
    )
    ...
    opt_map = visualize_assignments(
        ...
        save_path=os.path.join(output_dir, f"optimized_assignment_map_{timestamp}.html"),
        show=True
    )
    
    return admin_stats, opt_stats, admin_map, opt_map
